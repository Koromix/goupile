...
if NOT ERRORLEVEL 1 (
    ...
    if NOT ERRORLEVEL 1 (
        ...
        mkdir %TEMP%
        clang-cl /nologo /std:c++20 /I../.. /W0 /EHsc /MP /DNDEBUG /DNOMINMAX /DWINVER=0x0601 /D_WIN32_WINNT=0x0601 /DUNICODE /D_UNICODE /DLIBCC_NO_MINIZ /DLIBCC_NO_BROTLI /c %SRC% /Fo%TEMP%\
    ...
    mkdir %TEMP%
    cl /nologo /std:c++20 /I../.. /W0 /EHsc /MP /DNDEBUG /DNOMINMAX /DWINVER=0x0601 /D_WIN32_WINNT=0x0601 /DUNICODE /D_UNICODE /DLIBCC_NO_MINIZ /DLIBCC_NO_BROTLI /c %SRC% /Fo%TEMP%\
...
if NOT ERRORLEVEL 1 (
    ...
    mkdir %TEMP%
    g++ -std=gnu++2a -O0 -I../.. -DNDEBUG -DNOMINMAX  -DWINVER=0x0601 -D_WIN32_WINNT=0x0601 -DUNICODE -D_UNICODE0 -DLIBCC_NO_MINIZ -DLIBCC_NO_BROTLI %SRC% -lws2_32 -ladvapi32 -lshell32 -lole32 -luuid -w -o%TEMP%\felix.exe
    %TEMP%\felix.exe -pFast felix %*
    copy %BUILD%\felix.exe %BINARY% >NUL
